  ...
  return (
    <footer className="border-t border-line bg-white py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center md:flex-row md:justify-between md:text-left">
        <div>
          <p className="font-semibold text-ink">Soujanya S</p>
          <p className="text-sm text-muted">AI/ML Engineering Student • Bangalore, India</p>
        </div>

        <div className="flex items-center gap-4">
          <a href={`mailto:${socials.email}`} aria-label="Email" className="text-muted hover:text-accent">
          ...
          <button
            ...
            className="ml-2 rounded-md border border-line p-2 text-muted hover:border-accent hover:text-accent"
          >
