import { ShieldAlert, PawPrint, Camera, Radio } from 'lucide-react';
...
export const projects = [
  {
    ...
    visualIcon: Radio,
    visualGradient: "from-emerald-500/15 via-teal-400/10 to-transparent",
    description:
  ...
  },
  {
    ...
    visualGradient: "from-fraud/15 via-accent/10 to-transparent",
    description:
    ...
    achievements: [],
    features: [],
    github: "https://github.com/SoujanyaS257/scamshield-ai",
    demo: null,
  },
  {
    ...
    visualIcon: PawPrint,
    visualGradient: "from-indigo-500/15 via-violet-400/10 to-transparent",
    description:
    ...
    github: "https://github.com/SoujanyaS257/Dog_Skin_Disease_Detector",
    demo: null,
  },
  {
    ...
    visualIcon: Camera,
    visualGradient: "from-violet-500/15 via-indigo-400/10 to-transparent",
    description:
    ...
    github: "https://github.com/SoujanyaS257/Real-Time-Object-Detection",
    demo: null,
  },
];